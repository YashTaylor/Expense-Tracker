        ...
        AnimatedVisibility(visible = bottomBarVisibility) {
            NavigationBottomBar(
                navController = navController, items = listOf(
                    NavItems(route = "/home", icon = R.drawable.ic_home),
                    NavItems(route = "/stats", icon = R.drawable.ic_stats),
                )
            )
        }
    }) {
...
@Composable
fun NavigationBottomBar(navController: NavController, items: List<NavItems>) {
